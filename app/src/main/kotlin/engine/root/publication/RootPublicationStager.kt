...
internal object RootPublicationStager {
    fun stage(
        ...
        val coreConfig = writeStagedFile(directory, "mihomo-config-", ".yaml", coreConfigBytes)
        return try {
            RootStagedPublication(
    ...
    private fun writeStagedFile(directory: File, prefix: String, suffix: String, content: ByteArray): File {
